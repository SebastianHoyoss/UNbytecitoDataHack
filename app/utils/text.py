...
def infer_category(url: str, title: str = "") -> str:
    ...
    mapping = {
        ...
        "cronograma": "fechas_importantes",
        "calendario": "fechas_importantes",
        "fecha": "fechas_importantes",
        "convocatoria": "fechas_importantes",
        "plazo": "fechas_importantes",
        "costo": "costos",
        "matric": "costos",
        ...
        "maestr": "oferta_academica",
        "doctor": "oferta_academica",
